...
class Generator(nn.Module):
    # initializers
    def __init__(self, num_classes, shape_img, batchsize, channel=1, g_in=128, d = 32):
        ...
        self.fc2 = nn.Sequential(
            nn.Linear(g_in, num_classes)   #16 *10
        )
...
#         for bn in reversed(range(block_num)):
#             self.blocks.append(self.upBlock(pow(2, bn + 1) * d, pow(2, bn) * d))
#         self.deconv_out = self.upBlock(d, channel, output_size=(28, 28))
#
#     @staticmethod
#     def upBlock(in_planes, out_planes, output_size=None):
#         def conv3x3(in_planes, out_planes):
#             "3x3 convolution with padding"
#             return nn.Conv2d(in_planes, out_planes, kernel_size=3, stride=1,
#                              padding=1, bias=False)
